...
for i in range( 0, 7 ) :
    ...
    print( "\nDistances: %s" %tempEuclideanDistances)
    ...
    print( "\nNodes: %s" %tempNodes)
    print( "Distances: %s" %tempDistances)
    print( "Coords: %s\n" %tempCoords)
    print( "Random number: %s\n" %nRand)
    print( "That node: %s" %tempNodes[nRand] )
    nodeBool[ tempNodes[nRand] ] = False
    print( "That distance: %s\n" %tempDistances[nRand] )
    print( "That coord: %s" %tempCoords[nRand])
...
print(nodeBool)
print(route)
print( "Distance: %s distance units" %routeDistance )